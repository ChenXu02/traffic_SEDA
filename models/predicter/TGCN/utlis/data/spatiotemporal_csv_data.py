...
class SpatioTemporalCSVDataModule(pl.LightningDataModule):
    def __init__(
        ...
        **kwargs
        ...
        self._feat,self._feat2 = utils.data.functions.load_features(self._feat_path,self._feat_path2)
        self._feat_max_val = [np.mean(self._feat),np.std(self._feat)]
        self._feat_max_val2 = [np.mean(self._feat2),np.std(self._feat2)]
    ...
    def val_dataloader(self):
        return DataLoader(self.val_dataset, batch_size=len(self.val_dataset),num_workers=12)
